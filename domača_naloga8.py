...
def dolzina_ovir(ovire): #sesteva sezname
...
def senca(ovire): #klici globino ki je enaka None
    return [globina(ovire, x) == None for x in range(1, max(x for _, x, _ in ovire) + 1)]
